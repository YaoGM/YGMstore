...
favicon: /img/touxiang.png

# 用于苹果设备的图标
# Icon for Apple touch
apple_touch_icon: /img/touxiang.png
...
navbar:
  ...
  menu:
   ...
   # - { key: "tag", link: "/tags/", icon: "iconfont icon-tags-fill" }
    ...
    - { key: "其他", link: "/其他/", icon: "iconfont icon-bug"     }
